...
public class PrimitiveTypeTemplate : IDataTemplate
{
    ...
    public IControl Build(object data)
    {
        ...
        else if(data is int or byte or short or ushort or ushort or uint or long or ulong or float or double or decimal) return new NumericUpDown { Value = Convert.ToDouble(data) };
