...
CREATE TABLE IF NOT EXISTS geo.country (
  country_id uuid NOT NULL primary key default uuidv7(),
  iso_code char(2) NOT NULL unique,
  ascii_country_name text NOT NULL unique constraint country_ascii_country_name_le_80 check (char_length(ascii_country_name) <= 80),
  country_name text NOT NULL unique constraint country_country_name_le_80 check (char_length(country_name) <= 80),
